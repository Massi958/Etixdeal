...
# cheminDoc="C:\Users\massi\Desktop\project"+Titre_Doc
  if st.button('Finaliser le contrat'):
          document = DocxTemplate("TEMPLATE Cdi.docx")
          context = {"REMUNERATION":REMUNERATION,"NOMBRE_JOUR_TELETRAVAIL_PAR_SEMAINE":NOMBRE_JOUR_TELETRAVAIL_PAR_SEMAINE,"REMUNERATION_EN_LETTRE":REMUNERATION_EN_LETTRE,"PRONOM":PRONOM,"STATUT":STATUT,"POSITION":POSITION,"COEFFICIENT":COEFFICIENT,"SEXE":SEXE,"NOM_PRENOM":NOM_PRENOM,"ADRESSE":ADRESSE,"QUALITE":QUALITE,"DATE_REDACTION":DATE_REDACTION,"DATE_DEBUT_CONTRAT":DATE_DEBUT_CONTRAT}
          document.render(context)
          Titre_Doc="Contrat CDI "+NOM_PRENOM+".docx"
          document.save(Titre_Doc)
          
          inputFile = "Contrat CDI "+NOM_PRENOM+".docx"
        #   outputFile = "Contrat CDI "+NOM_PRENOM+".pdf"
